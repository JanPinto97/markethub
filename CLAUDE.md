...
- ALWAYS REMIND THE USER TO COMMIT CHANGES ONCE A FEATURE IS COMPLETED.
- UPDATE THIS FILE AFTER EVERY SUCCESSFULLY IMPLEMENTED FEATURE.
- EVERY TIME YOU MAKE A CHANGE IN app.routes.ts MENTION IT TO THE USER
  AND WARN HIM OF THE POSSIBLE MERGE CONFLICT.
